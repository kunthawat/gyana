    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conditional_formatting', models.BooleanField(default=False, help_text='Select whether or not to show background color')),
                ('positive_threshold', models.IntegerField(default=0, help_text='Set a threshold for positive value')),
                ('negative_threshold', models.IntegerField(default=0, help_text='Set a threshold for negative value')),

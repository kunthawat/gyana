    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_tooltips', models.BooleanField(blank=True, default=True)),
                ...
                ('table_show_header', models.BooleanField(blank=True, default=True, verbose_name='Show table header')),
                ('table_hide_data_type', models.BooleanField(blank=True, default=False, verbose_name='Hide data type icon')),
                ('table_paginate_by', models.PositiveIntegerField(default=15, validators=[django.core.validators.MaxValueValidator(100)], verbose_name='Rows per page')),
                ('lower_limit', models.IntegerField(default=0)),
                ('upper_limit', models.IntegerField(default=100)),
                ('first_segment_color', models.CharField(max_length=7, null=True)),
                ('second_segment_color', models.CharField(max_length=7, null=True)),
                ('third_segment_color', models.CharField(max_length=7, null=True)),
                ('fourth_segment_color', models.CharField(max_length=7, null=True)),
                ('text_content', models.TextField(blank=True, null=True)),
                ('url', models.URLField(blank=True, null=True)),
                ('image', models.FileField(blank=True, null=True, upload_to='cypress/dashboard_images')),
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='widgets', to='dashboards.page')),

...
dashboard_urlpatterns = (
    [
        ...
        path("<hashid:pk>", views.WidgetDetail.as_view(), name="detail"),
        path("<hashid:pk>/update", views.WidgetUpdate.as_view(), name="update"),
        path("<hashid:pk>/delete", views.WidgetDelete.as_view(), name="delete"),

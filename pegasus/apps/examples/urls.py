...
urlpatterns = [
    ...
    path(
        "payments/confirm/<slug:payment_id>/",
    ...
    path(
        ...
        name="react_object_lifecycle",
    ),
    path(
        "objects/react/<path:path>",
        views.ReactObjectLifecycleView.as_view(),
    ...
    path(
        "api/employee-data/", views.EmployeeDataAPIView.as_view(), name="employee_data"
    ),
]
